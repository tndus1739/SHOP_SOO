...
const MyInfo = () => {
  ...
  const handleUpdate = async () => {
    try {
      ...
      const response = await UserMyPageMemberService.updateUser(id, updatedUserData);
